...
return array (
  ...
  'newsletter:edit:from:description' => 'Standaard worden de nieuwsbrieven verstuurd vanaf %s. Je kunt een aangepast e-mailadres opgeven. Dit e-mailadres zal ook alle non-delivery reports ontvangen.',
  ...
  'newsletter:edit:from' => 'Aangepast afzender e-mailadres (optioneel)',
  'newsletter:settings:custom_from' => 'Nieuwsbrieven mogen worden verzonden met een aangepast e-mailadres',
  'newsletter:settings:custom_from:description' => 'Als deze optie op \'ja\' wordt gezet is het gebruikers toegestaan om een aangepast e-mailadres op te geven als de afzender van de nieuwsbrief. Houd er rekening mee dat dit misbruikt kan worden en dat de kans dat nieuwsbrieven als spam worden gemarkeerd toeneemt.',
  'newsletter:settings:custom_from:domains' => 'Beperkt de aangepaste e-mailadressen tot de volgende domeinen',
  ...
  'newsletter:action:edit:error:from' => 'The opgegeven e-mailadres is niet toegestaan voor het verzenden van nieuwsbrieven',
  'newsletter:schedule:status_notification:me' => 'Stuur mij een status bericht',
  'newsletter:schedule:status_notification:toggle' => 'of geef een ander e-mailadres op',
  ...
  'newsletter:csv:added' => '%s e-mailadressen toegevoegd vanuit het CSV-bestand',
  'newsletter:recipients:csv' => 'Upload een CSV-bestand met e-mailadressen van ontvangers',
  'newsletter:recipients:csv:description' => 'Je kunt een CSV-bestand uploaden welke e-mailadressen van ontvangers bevat. Het tekst scheidingsteken moet een " (dubbel quote) zijn en het kolom scheidingsteken moet een ; (puntkomma) zijn. Het systeem zoekt zelf naar de kolom met e-mailadressen door de eerste 2 regels te doorzoeken.',
  ...
  'newsletter:schedule:status_notification' => 'E-mailadres voor een status bericht',
  'newsletter:schedule:status_notification:description' => 'Als de nieuwsbrief is verzonden zal er een bericht worden verzonden naar dit e-mailadres.',
  ...
  'newsletter:settings:include_existing_users:description' => 'Indien ingeschakeld zullen ook gebruikers worden toegevoegd die géén abonnement voorkeur hebben opgegeven.',
...
controleer de twee instellingen hieronder en klik op uitschrijven om het het proces af te ronden.',
  'newsletter:unsubscribe:email' => 'Je e-mailadres %s zal worden uitgeschreven als je op de onderstaande knop klik.',
  'newsletter:unsubscribe:email:empty' => 'Voer het e-mailadres in wat u wilt uitschrijven.',
...
%s',
  ...
  'newsletter:log:users:header:email' => 'E-mailadres',
  'newsletter:log:users:header:time' => 'Tijd',
  'newsletter:log:users:header:status' => 'Status',
  'newsletter:log:users:header:guid' => 'Gebruiker',
  'newsletter:log:emails:title' => 'E-mailadressen',
  'newsletter:log:email:header:email' => 'E-mailadres',
  ...
  'newsletter:log:general:scheduled' => 'Geplande aflevertijd',
  'newsletter:log:general:starttime' => 'Echte starttijd',
